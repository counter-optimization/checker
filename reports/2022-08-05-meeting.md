...
By cases:
(the 'desired slice' flags, the 'flag calc part' flags) -> safe
(the 'desired slice' doesn't flag, the 'flag calc part' flags) ->
overapprox/false pos
(the 'desired slice' flags, the 'flag calc part' flags) -> safe
neither flag -> safe to ignore
...
`test`, `cmovcc` insns are also pretty messy like this.
