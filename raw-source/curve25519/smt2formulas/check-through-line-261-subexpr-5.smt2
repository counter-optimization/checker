...
(assert (not (= (_ bv0 16) (bvand (bvadd (bvadd (bvadd (bvadd (bvadd (bvmul f10 f20) (bvmul f11 (bvmul f24 (_ bv19 16)))) (bvmul f12 (bvmul f23 (_ bv19 16)))) (bvmul f13 (bvmul f22 (_ bv19 16)))) (bvmul f14 (bvmul f21 (_ bv19 16)))) (_ bv0 16)) #xffff))))
